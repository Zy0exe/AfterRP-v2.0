RegisterServerEvent('ZyoCore:DebugSomething')
AddEventHandler('ZyoCore:DebugSomething', function(resource, obj, depth)
...
ZyoCore.Debug = function(resource, obj, depth)
    TriggerEvent('ZyoCore:DebugSomething', resource, obj, depth)
end

ZyoCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

ZyoCore.ShowSuccess = function(resource, msg)
