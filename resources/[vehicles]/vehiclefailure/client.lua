...
function CleanVehicle(vehicle)
	...
	print('deu')
	ZyoCore.Functions.Progressbar("repair_vehicle", "A limpar veiculo...", math.random(10000, 20000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	}, {}, {}, {}, function() -- Done
		ZyoCore.Functions.Notify("Veiculo limpo com sucesso!")
		SetVehicleDirtLevel(vehicle, 0.1)
        SetVehicleUndriveable(vehicle, false)
		WashDecalsFromVehicle(vehicle, 1.0)
		TriggerServerEvent('vehiclefailure:server:removewashingkit', vehicle)
		TriggerEvent('inventory:client:ItemBox', ZyoCore.Shared.Items["cleaningkit"], "remove")
...
function RepairVehicleFull(vehicle)
	...
	print('deu')
	ZyoCore.Functions.Progressbar("repair_vehicle", "A reparar veiculo..", math.random(20000, 30000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
		...
		ZyoCore.Functions.Notify("Veiculo reparado com sucesso!")
...
function RepairVehicle(vehicle)
	...
	print('deu')
	ZyoCore.Functions.Progressbar("repair_vehicle", "A Reparar veiculo..", math.random(10000, 20000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
Citizen.CreateThread(function()
    while true do
        ...
        if showPro then
            ZyoCore.Functions.DrawText3D(pos.x, pos.y, pos.z, TimeLeft .. '~g~%')
        end
    end
end)
