...
ZyoCore.Functions.Notify("Use Radio RP","success", 3000)
...
--ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
 --if quantity >= 1 then
	...
	if PlayerData.job ~= nil and (PlayerData.job.name == 'police' or PlayerData.job.name == 'mechanic' or PlayerData.job.name == 'ambulance') then
		...
		ZyoCore.Functions.Notify("YOU ARE USING THE SERVICE RADIO!","success", 3000)
	...
	elseif PlayerData.job ~= nil and PlayerData.job.name == 'thelost' then
		...
		ZyoCore.Functions.Notify("YOU ARE USING THE GANG RADIO!","success", 3000)
	...
	ZyoCore.Functions.Notify("YOU ARE USING THE RADIO!","success", 3000)
	end
	local playerPed = PlayerPedId()
	local count = 0
