...
AddEventHandler('ZyoCore:Client:OnPlayerLoaded', function()
    ...
    ZyoCore.Functions.TriggerCallback('qb-scoreboard:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                ZyoCore.Functions.TriggerCallback('qb-scoreboard:server:GetPlayersArrays', function(playerList)
                    ZyoCore.Functions.TriggerCallback('qb-scoreboard:server:GetActivity', function(cops, ambulance)
