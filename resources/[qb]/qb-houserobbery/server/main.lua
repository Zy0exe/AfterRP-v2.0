...
ZyoCore.Functions.CreateCallback('qb-houserobbery:server:GetHouseConfig', function(source, cb)
    cb(Config.Houses)
end)
...
AddEventHandler('qb-houserobbery:server:searchCabin', function(cabin, house)
    ...
    if itemFound < 4 then
        ...
        TriggerClientEvent('ZyoCore:Notify', src, 'The cabin is empty bro', 'error', 3500)
    end
