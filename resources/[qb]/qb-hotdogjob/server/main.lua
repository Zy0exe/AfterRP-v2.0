...
ZyoCore.Functions.CreateCallback('qb-hotdogjob:server:HasMoney', function(source, cb)
...
ZyoCore.Functions.CreateCallback('qb-hotdogjob:server:BringBack', function(source, cb)
    local Player = ZyoCore.Functions.GetPlayer(source)
...
ZyoCore.Commands.Add("removestand", "", {}, false, function(source, args)
