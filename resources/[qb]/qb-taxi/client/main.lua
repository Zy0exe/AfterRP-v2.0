    ...
    if whitelistedVehicle() then
        if NpcData.CountDown == 180 then
            if not NpcData.Active then
                ...
                ZyoCore.Functions.Notify('A localização de um americano foi definida no teu GPS!', 'success')
                        ...
                        if dist < 20 then
                            ...
                            if dist < 5 then
                                ...
                                if IsControlJustPressed(0, Keys["E"]) then
                                    ...
                                    ZyoCore.Functions.Notify('Leva o americano até o seu destino.')
                                    if NpcData.NpcBlip ~= nil then
                                        RemoveBlip(NpcData.NpcBlip)
                                    end
                                    GetDeliveryLocation()
                ...
                ZyoCore.Functions.Notify('Ja estas a fazer serviços a americanos..')
            end
        else
            ZyoCore.Functions.Notify('De momento não tem serviços para americanos..')
        end
    else
        ZyoCore.Functions.Notify('Não estas dentro de um taxi')
    end
end)
            ...
            if dist < 20 then
                ...
                if dist < 5 then
                    ...
                    if IsControlJustPressed(0, Keys["E"]) then
                        ...
                        ZyoCore.Functions.Notify('Entregas-te o americano no seu destino.', 'success')
                        if NpcData.DeliveryBlip ~= nil then
                            RemoveBlip(NpcData.DeliveryBlip)
                        end
...
AddEventHandler('qb-taxi:client:toggleMeter', function()
    ...
    if IsPedInAnyVehicle(ped, false) then
        if whitelistedVehicle() then
            ...
            ZyoCore.Functions.Notify('Não estas num taxi...', 'error')
        end
    else
        ZyoCore.Functions.Notify('Não estas dentro de um veiculo..', 'error')
    end
end)
...
AddEventHandler('qb-taxi:client:enableMeter', function()
    ...
    if meterIsOpen then
        ...
        ZyoCore.Functions.Notify('O taximetro não esta ativo..', 'error')
    end
end)
...
AddEventHandler('qb-taxi:client:toggleMuis', function()
    ...
    if meterIsOpen then
        ...
        ZyoCore.Functions.Notify('Não tens o taximetro ativo..', 'error')
    end
end)
...
function TakeVehicle(k)
    ...
    ZyoCore.Functions.SpawnVehicle(Config.AllowedVehicles[k].model, function(veh)
