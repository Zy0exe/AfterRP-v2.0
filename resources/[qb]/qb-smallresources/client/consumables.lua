...
AddEventHandler("consumables:client:UseJoint", function()
    ZyoCore.Functions.Progressbar("smoke_joint", "A dar umas passas..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["joint"], "remove")
...
AddEventHandler("consumables:client:UseParachute", function()
    EquipParachuteAnim()
    ZyoCore.Functions.Progressbar("use_parachute", "parachute using..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["parachute"], "remove")
...
AddEventHandler("consumables:client:ResetParachute", function()
    if ParachuteEquiped then 
        EquipParachuteAnim()
        ZyoCore.Functions.Progressbar("reset_parachute", "A abrir o paraquedas..", 40000, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
            ...
            local ped = GetPlayerPed(-1)
            TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["parachute"], "add")
        ...
        ZyoCore.Functions.Notify("Não tens nenhum paraquedas aberto!", "error")
    end
end)
...
--         TriggerEvent("inventory:client:Itembox", ZyoCore.Shared.Items["smoketrailred"], "remove")
--     else
--         ZyoCore.Functions.Notify("You need to have a paracute to activate smoke!", "error")    
--     end
-- end)

RegisterNetEvent("consumables:client:UseArmor")
AddEventHandler("consumables:client:UseArmor", function()
    ZyoCore.Functions.Progressbar("use_armor", "A vestir o Colete..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["armor"], "remove")
        TriggerServerEvent('hospital:server:SetArmor', 75)
        TriggerServerEvent("ZyoCore:Server:RemoveItem", "armor", 1)
...
AddEventHandler("consumables:client:UseHeavyArmor", function()
    ...
    ZyoCore.Functions.Progressbar("use_heavyarmor", "A vestir o Colete..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["heavyarmor"], "remove")
        TriggerServerEvent("ZyoCore:Server:RemoveItem", "heavyarmor", 1)
...
AddEventHandler("consumables:client:ResetArmor", function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then 
        ZyoCore.Functions.Progressbar("remove_armor", "A remover o Colete..", 2500, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
            ...
            SetPedArmour(ped, 0)
            TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["heavyarmor"], "add")
            TriggerServerEvent("ZyoCore:Server:AddItem", "heavyarmor", 1)
        end)
    else
        ZyoCore.Functions.Notify("Não estas a usar um colete...", "error")
    end
end)
...
AddEventHandler("consumables:client:DrinkAlcohol", function(itemName)
    ...
    ZyoCore.Functions.Progressbar("snort_coke", "Consumindo..", math.random(3000, 6000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items[itemName], "remove")
        TriggerServerEvent("ZyoCore:Server:RemoveItem", itemName, 1)
        TriggerServerEvent("ZyoCore:Server:SetMetaData", "thirst", ZyoCore.Functions.GetPlayerData().metadata["thirst"] + Consumeables[itemName])
        alcoholCount = alcoholCount + 1
...
AddEventHandler("consumables:client:Cokebaggy", function()
    ZyoCore.Functions.Progressbar("snort_coke", "Consumindo..", math.random(5000, 8000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerServerEvent("ZyoCore:Server:RemoveItem", "cokebaggy", 1)
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["cokebaggy"], "remove")
...
AddEventHandler("consumables:client:Crackbaggy", function()
    ZyoCore.Functions.Progressbar("snort_coke", "Smoking crack..", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(GetPlayerPed(-1), "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent("ZyoCore:Server:RemoveItem", "crack_baggy", 1)
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["crack_baggy"], "remove")
...
AddEventHandler('consumables:client:EcstasyBaggy', function()
    ZyoCore.Functions.Progressbar("use_ecstasy", "Pillen poppen", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerServerEvent("ZyoCore:Server:RemoveItem", "xtcbaggy", 1)
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items["xtcbaggy"], "remove")
        EcstasyEffect()
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "mp_suicide", "pill", 1.0)
        ZyoCore.Functions.Notify("Cancelado", "error")
...
AddEventHandler("consumables:client:Eat", function(itemName)
    ...
    ZyoCore.Functions.Progressbar("eat_something", "A Comer..", 2500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", ZyoCore.Shared.Items[itemName], "remove")
        TriggerEvent('animations:client:EmoteCommandStart', {"c"})
        TriggerServerEvent("ZyoCore:Server:SetMetaData", "hunger", ZyoCore.Functions.GetPlayerData().metadata["hunger"] + Consumeables[itemName])
...
AddEventHandler("consumables:client:Drink", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
    ZyoCore.Functions.Progressbar("drink_something", "A Beber..", 2500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
