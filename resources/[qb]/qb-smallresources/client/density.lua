Citizen.CreateThread(function()
    while true do
	Citizen.Wait(0)
        SetVehicleDensityMultiplierThisFrame(0) --Seleciona densidade do trafico
	SetPedDensityMultiplierThisFrame(0) --seleciona a densidade de Npc
	SetRandomVehicleDensityMultiplierThisFrame(0) --seleciona a densidade de viaturas estacionadas a andar etc
	SetParkedVehicleDensityMultiplierThisFrame(0) --seleciona a densidade de viaturas estacionadas
	SetScenarioPedDensityMultiplierThisFrame(0, 0) --seleciona a densidade de Npc a andar pela cidade
