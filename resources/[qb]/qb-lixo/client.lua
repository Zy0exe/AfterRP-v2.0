                    ...
                    if IsControlJustReleased(0, 54) then
                        for i = 1, #searched do
                            ...
                            if i == #searched and dumpsterFound then
                                ZyoCore.Functions.Notify('Este Caixote do Lixo ja foi vasculhado', 'error')
                            elseif i == #searched and not dumpsterFound then
                                ZyoCore.Functions.Notify('Começas-te a vasculhar o Caixote do Lixo')
...
function startSearching(time, dict, anim, cb)
 ...
 --   ZyoCore.Functions.Progressbar("reful_boat", "Searching The dumpster..", 14000)
