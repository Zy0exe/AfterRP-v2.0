...
Citizen.CreateThread(function()
	...
	while ZyoCore.Functions.GetPlayerData().job == nil do
		Citizen.Wait(10)
	end
...
local blips = {
    {title="Vanilla", colour=61, id=121, x = 96.18, y = -1306.34, z = 29.29}
              ...
              ----se sono in macchina non esegue nessuna funzione
				...
				---------controllo se ho i punti xp---------------------------------------------------
                         ...
                         --controllo se ho l'item
                                        ZyoCore.Functions.TriggerCallback('ZyoCore:HasItem', function(result2)
                                        hasBagd7 = result2
                                        s1d7 = true
                                        end, 'black_money')
                                        while(not s1d7) do
                                        Citizen.Wait(100)
                                                  ...
                                                  ----se ho l'item eseguo
                                                    if (hasBagd7) then
                                                      ...
                                                      ZyoCore.Functions.Notify('Não tens dinheiro sujo', 'error')
                                                    end
...
function procOn()
    ...
    local inventory = ZyoCore.Functions.GetPlayerData().inventory
    local count = 0
    ----
    if(count == 0) then
    ZyoCore.Functions.Progressbar("search_register", "A lavar..", 20000, false, true, {disableMovement = true,
