...
AddEventHandler('qb-diving:client:SetDivingLocation', function(DivingLocation)
    ...
    Citizen.CreateThread(function()
        RadiusBlip = AddBlipForRadius(ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.x, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.y, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.z, 100.0)
        ...
        LabelBlip = AddBlipForCoord(ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.x, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.y, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.z)
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentDivingLocation.Area ~= 0 then
            local AreaDistance = GetDistanceBetweenCoords(Pos, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.x, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.y, ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Area.z)
            ...
            if inRange then
                for cur, CoralLocation in pairs(ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Coral) do
                            ...
                            if not CoralLocation.PickedUp then
                                ...
                                if CoralDistance <= 1.5 then
                                    ...
                                    if IsControlJustPressed(0, Keys["E"]) then
                                        ...
                                        ZyoCore.Functions.Progressbar("take_coral", "Collecting coral..", times * 1000, false, true, {
...
function TakeCoral(coral)
    ZyoCoreDiving.Locations[CurrentDivingLocation.Area].coords.Coral[coral].PickedUp = true
...
AddEventHandler('qb-diving:client:UseGear', function(bool)
    if bool then
        GearAnim()
        ZyoCore.Functions.Progressbar("equip_gear", "Putting on wet suit..", 5000, false, true, {}, {}, {}, {}, function() -- Done
            DeleteGear()
        ...
        if currentGear.enabled then
            GearAnim()
            ZyoCore.Functions.Progressbar("remove_gear", "Removing wet suit..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
                ...
                ClearPedTasks(GetPlayerPed(-1))
                ZyoCore.Functions.Notify('You took your wetsuit off')
            end)
        else
            ZyoCore.Functions.Notify('You are not wearing a diving gear..', 'error')
        end
    end
end)
