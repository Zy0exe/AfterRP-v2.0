...
RentVehicle = function(selectedVehicle)
    ...
    if IsPedInAnyVehicle(ped) then
        ZyoCore.Functions.Notify('this can only when not in a vehicle..', 'error')
        return
    end
...
ReturnVehicle = function()
    ...
    ZyoCore.Functions.Notify('You do not have a deposit open..', 'error')
end
...
AcceptReturn = function()
    ...
    if noSpace(VehiclePlate) ~= noSpace(RentedVehiclePlate) then
        ZyoCore.Functions.Notify('This is not a rental vehicle..', 'error')
    else
        ...
        ZyoCore.Functions.DeleteVehicle(CurrentVehicle)
